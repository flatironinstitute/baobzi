...
struct PolyTree {
    ...
    inline PolyTree(const baobzi_input_t &input, const Box<value_type, input_dim> &box,
...
class Function {
  public:
    ...
    inline Function(const baobzi_input_t &input, const input_type center, const input_type half_width_in,
                    const Func &func)
    ...
    inline std::pair<dim_array_t, dim_array_t> get_bounds() const { return std::make_pair(lower_left_, upper_right_); }
